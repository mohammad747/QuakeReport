    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i<= features.length(); i++) {
                ...
                JSONObject subObj;
                subObj = obj.getJSONObject("properties");
                double mag = Double.parseDouble(subObj.getString("mag"));
                String place = subObj.getString("place");
                String part1 = null;
                String part2 = null;
                ...
                long time = subObj.getLong("time");
                // Extract the value for the key called "url"
                String url = subObj.getString("url");
                Earthquake earthquake = new Earthquake(mag, part1, part2, time,url);
